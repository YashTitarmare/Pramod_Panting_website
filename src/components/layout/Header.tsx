...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-white/98 backdrop-blur-md border-t shadow-xl">
          <div className="px-4 py-4 md:py-6 space-y-2 md:space-y-4">
            ...
            <div className="pt-3 md:pt-4 space-y-3 md:space-y-4">
              <a
                ...
                className="flex items-center gap-2 md:gap-3 text-[#0f4c75] font-semibold text-sm md:text-base"
              >
                <Phone className="w-4 h-4 md:w-5 md:h-5" />
                +91 8788118802
              </a>
              <div className="flex items-center gap-2 text-xs md:text-sm text-slate-500">
                <ShieldCheck className="w-3 h-3 md:w-4 md:h-4 text-[#00b894]" />
                Licensed & Insured
              </div>
              <Link
                href="/quote"
